...
export default function () {
  ...
  const toggleSection = (section: keyof SectionsOpenState) => {
      ...
      >
        ...
        <section className="w-full my-1 px-screen-x">
          <div className="flex items-end justify-between text-sm text-gray-500">
            <p>즐겨찾기</p>
            <FontAwesomeIcon
              onClick={() => toggleSection("starFriends")}
              icon={sectionsOpen.starFriends ? faChevronUp : faChevronDown}
              className="cursor-pointer"
            />
          </div>
          {sectionsOpen.starFriends && starMembers && (
            <FriendList
              friends={starMembers}
        ...
        <section className="w-full my-1 px-screen-x">
          <div className="flex items-end justify-between text-sm text-gray-500">
            ...
            <FontAwesomeIcon
              ...
              icon={sectionsOpen.friends ? faChevronUp : faChevronDown}
              className="cursor-pointer"
            />
          </div>
          {sectionsOpen.friends && friends && (
            <FriendList
              friends={friends}
              onFriendClick={(friend: FriendType) => {
                dispatch(openProfileDetail(friend));
